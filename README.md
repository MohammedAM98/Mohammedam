<!DOCTYPE html>
  <head>
    ...
    <title>Project Snake Game Mohammed Almutawa </title>
    <style>
        .game-box {
            text-align:center;  
            font-family:arial;
...
h2{
  ...
  <body>
    ...
    <div class="game-info">
        ...
        <p id="game-status"></p>
        <p id="game-score"></p>
        <img src="moh.jpg"height= "50" weidth "50">
    ...
    <script>
     ...
     alert("Enjoy");
      ...
      const CANVAS_BORDER_COLOUR = '#FF8000';
      const CANVAS_BACKGROUND_COLOUR = "#CEF6E3";
      const SNAKE_COLOUR = 'lightgreen';
      const SNAKE_BORDER_COLOUR = '#D0F5A9';
